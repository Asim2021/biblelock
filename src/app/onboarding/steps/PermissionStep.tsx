...
export const PermissionStep: React.FC<PermissionStepProps> = ({ onBack, onComplete }) => {
		...
		>
			...
			>
				...
				<View className='flex-row space-x-1.5 pt-4 mb-4'>
					{[1, 2, 3, 4, 5].map((idx) => (
						<View key={idx} className='flex-1 h-1 rounded-full mr-1.5 bg-[#f5b800]' />
					))}
				</View>

				<Text className='text-xs font-sans-bold text-[#f5b800] mb-3'>5 of 5</Text>

				<Text
					className='text-[32px] font-serif-bold text-[#faf9f5] mb-2 tracking-tight leading-[40px]'
					style={{ fontFamily: 'EBGaramond_700Bold' }}
				>
					Let's protect your time with Jesus
				</Text>
				...
				<View
					className={`p-6 rounded-3xl items-center justify-center mb-4 border ${
						hasPermission ? 'border-[#5db872] bg-[#143e32]' : 'border-[#265e4d] bg-[#12382d]'
					}`}
				>
					{hasPermission ? (
						<View className='items-center'>
							...
							<Text className='text-xl font-sans-bold text-[#faf9f5] mb-2'>Bible Shield Active</Text>
							<Text className='text-xs font-sans text-[#aee2d1] text-center px-4 leading-relaxed'>
								Your shield is enabled! Distractions will stay paused during your daily Bible time with
								Jesus.
							</Text>
						</View>
					) : (
						<View className='items-center w-full'>
							<View className='w-14 h-14 rounded-lg bg-[#1d5242] items-center justify-center mb-1'>
								<Lock size={32} color='#f5b800' strokeWidth={2} />
							</View>
							<Text className='text-xl font-sans-bold text-[#faf9f5] mb-2'>Bible Shield Service</Text>
							<Text className='text-xs font-sans text-[#78a898] text-center px-4 leading-relaxed mb-4'>
								Required to detect when distractions pull you away and gently redirect you back to Jesus
								in the Bible.
							</Text>
							...
							>
								...
								<Text className='text-lg font-sans-bold text-[#141413]'>Activate Bible Shield</Text>
							</Pressable>
						</View>
					)}
				</View>
				...
				{!hasPermission && (
					<View className='p-5 rounded-2xl bg-[#143e32] border border-[#205243] mb-4'>
						...
						<View className='space-y-3'>
							<View className='flex-row mb-2'>
								...
								<Text className='text-xs font-sans text-[#c8ded6] flex-1 leading-relaxed'>
									Tap <Text className='font-sans-bold text-white'>"Activate Bible Shield"</Text>{' '}
									above.
								</Text>
							</View>
							<View className='flex-row mb-2'>
				...
				<View className='p-4 rounded-2xl bg-[#143e32] border border-[#205243] flex-row items-center mb-6'>
					...
					<View className='flex-1'>
						<Text className='text-xs font-sans-bold text-[#faf9f5] mb-1'>Peaceful Reminders</Text>
						<Text className='text-[11px] font-sans text-[#78a898] leading-relaxed'>
							We'll send a gentle nudge when it's time to pause the noise and meet with Jesus.
						</Text>
					</View>
				</View>
			</ScrollView>
					...
					>
						<ScrollView showsVerticalScrollIndicator={false}>
								...
								<View className='flex-row mb-2'>
									...
									<Text className='text-xs font-sans text-[#c8ded6] flex-1 leading-relaxed'>
										<Text className='font-sans-bold text-white'>
											Detecting when you open shielded apps
										</Text>{' '}
										(like Instagram, TikTok, YouTube) during your scheduled reading times.
									</Text>
								</View>
								<View className='flex-row mb-2'>
									<Text className='text-[#f5b800] mr-2'>•</Text>
									<Text className='text-xs font-sans text-[#c8ded6] flex-1 leading-relaxed'>
										<Text className='font-sans-bold text-white'>Redirecting you to the Bible</Text>{' '}
										so you can spend unhurried quiet time with Jesus first.
									</Text>
								</View>
								<View className='flex-row mb-2'>
									<Text className='text-[#f5b800] mr-2'>•</Text>
									<Text className='text-xs font-sans text-[#c8ded6] flex-1 leading-relaxed'>
										<Text className='font-sans-bold text-white'>Unlocking apps automatically</Text>{' '}
										once you finish your daily minutes in God's Word.
									</Text>
								</View>
							</View>
							...
							<View className='space-y-2 mb-6'>
								<View className='flex-row items-center mb-2'>
									...
									<Text className='text-xs font-sans text-[#c8ded6]'>
										We only monitor apps YOU selected to shield
									</Text>
								</View>
								<View className='flex-row items-center mb-2'>
							...
							<View className='p-3.5 rounded-xl bg-[#281b1d] border border-[#4a2428] mb-6'>
								<View className='flex-row items-center'>
									...
									<Text className='text-xs font-sans text-[#ff9999] flex-1 leading-relaxed'>
										This permission is required for Bible Unlock to work. Without it, we cannot
										shield distracting apps during your quiet time with Jesus.
									</Text>
								</View>
							</View>
							...
							<View className='flex-row space-x-3 mb-2'>
								...
								>
									<Text className='text-sm font-sans-bold text-[#141413]'>Open Settings</Text>
								</Pressable>
							</View>
						</ScrollView>
					</View>
